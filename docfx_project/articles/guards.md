...
- [NullOrWhiteSpace](http://localhost:8080/api/Krafted.Guards.Guard.html#Krafted_Guards_Guard_NullOrWhiteSpace_System_String_System_String_)
- [NullOrWhiteSpace with message](http://localhost:8080/api/Krafted.Guards.Guard.html#Krafted_Guards_Guard_NullOrWhiteSpace_System_String_System_String_System_String_)
- [Positive](http://localhost:8080/api/Krafted.Guards.Guard.html#Krafted_Guards_Guard_Positive__1___0_System_String_)
- [Zero](http://localhost:8080/api/Krafted.Guards.Guard.html#Krafted_Guards_Guard_Zero__1___0_System_String_)
- [ZeroOrLess](http://localhost:8080/api/Krafted.Guards.Guard.html#Krafted_Guards_Guard_ZeroOrLess__1___0_System_String_)
- [Negative](http://localhost:8080/api/Krafted.Guards.Guard.html#Krafted_Guards_Guard_Negative__1___0_System_String_)
- [InvalidEmail](http://localhost:8080/api/Krafted.Guards.Guard.html#Krafted_Guards_Guard_InvalidEmail_System_String_)
- [InvalidNif](http://localhost:8080/api/Krafted.Guards.Guard.html#Krafted_Guards_Guard_InvalidNif_System_String_)
