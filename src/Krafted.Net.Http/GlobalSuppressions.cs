...
[assembly: SuppressMessage("Design", "CA1062:Validate arguments of public methods", Justification = "ExceptionHelper.ThrowIfAnyNull(() => response, () => anonymousTypeObject)", Scope = "member", Target = "~M:Krafted.Net.Http.HttpResponseMessageExtension.DeserializeAnonymousTypeAsync``1(System.Net.Http.HttpResponseMessage,``0)~System.Threading.Tasks.Task{``0}")]