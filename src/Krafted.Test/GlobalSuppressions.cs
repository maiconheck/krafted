...
[assembly: SuppressMessage("Design", "CA1062:Validate arguments of public methods", Justification = "response.ThrowIfNull(nameof(response))", Scope = "member", Target = "~M:Krafted.Test.IntegrationTest`1.#ctor(Krafted.Api.ProviderStateApiFactory{`0},System.String)")]