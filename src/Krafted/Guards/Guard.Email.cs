...
namespace Krafted.Guards
{
    ...
    {
        /// <summary>
        /// Throws an <see cref="FormatException"/> if the email address is invalid,
        ...
        {
            NullOrEmpty(emailAddress, nameof(emailAddress));
            ...
            if (!regEx.IsMatch(emailAddress))
                throw new FormatException($"E-mail address invalid: {emailAddress}");
