...
[assembly: SuppressMessage("Blocker Code Smell", "S3875:\"operator==\" should not be overloaded on reference types", Justification = "Not applicable for ValueObjects", Scope = "member", Target = "~M:Krafted.ValueObjects.ValueObject.op_Equality(Krafted.ValueObjects.ValueObject,Krafted.ValueObjects.ValueObject)~System.Boolean")]
[assembly: SuppressMessage("Blocker Code Smell", "S3875:\"operator==\" should not be overloaded on reference types", Justification = "Not applicable for ValueObjects", Scope = "member", Target = "~M:Krafted.ValueObjects.ValueObject`1.op_Equality(Krafted.ValueObjects.ValueObject`1,Krafted.ValueObjects.ValueObject`1)~System.Boolean")]
