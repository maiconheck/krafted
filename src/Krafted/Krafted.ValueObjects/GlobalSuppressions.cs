...
[assembly: SuppressMessage("General", "RCS1181:Convert comment to documentation comment.", Justification = "In this case, it's just a comment, and not a documentation comment.", Scope = "member", Target = "~M:Krafted.ValueObjects.Url.#ctor")]
